...
class Dummydb {
  static const List quesList = [
    ...
    {
      'question': 'What is the color of a typical school bus?',
  ...
  static const List geographyList = [
    {
  ...
  static const List chemistryList = [
    {
